...
namespace :fill_database do
  ...
  task board_games_middleman_csv: :environment do
    board_games1 = CSV.open "./db/data/board_game_middleman_api_data1.csv", headers: true, header_converters: :symbol
    board_games2 = CSV.open "./db/data/board_game_middleman_api_data2.csv", headers: true, header_converters: :symbol
    board_games3 = CSV.open "./db/data/board_game_middleman_api_data3.csv", headers: true, header_converters: :symbol
